...
import "@components/TsParticles/styles.css"
...
export default function BannerReact() {
    ...
    return (
        <Particles
            id="tsparticlesPreguntas"
            init={particlesInit}
            loaded={particlesLoaded}
            options={{
                autoPlay: true,
                    background: {
                    color: { value: "#1d6998fff" },
                    image: "",
                    position: "50% 50%",
                    repeat: "no-repeat",
                    size: "cover",
                    ...
                    shape: {
                        ...
                        image: [
                            {
                                src: "/iconAnimado/iconCIR.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            },
                            {
                                src: "/iconAnimado/iconCUAD.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            },
                            {
                                src: "/iconAnimado/iconNODO.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            },
                            {
                                src: "/iconAnimado/iconPIRA.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            },
                            {
                                src: "/iconAnimado/iconX.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            },
                            {
                                src: "/iconAnimado/iconTRI.svg",
                                height: 24,
                                replace_color: true,
                                width: 24
                            }
